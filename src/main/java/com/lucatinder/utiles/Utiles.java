...
public class Utiles {
	...
	
	{
		...
		Perfil perfil = new Perfil(Math.abs(random.nextInt()), "Seducci�n69", "Glymmdok LOpez Gonzalez", "Me gusta la pizza con pina y la paella con chorizo. Busco una "
				+"persona sincera, divertida y carinosa. <3", random.nextBoolean(), Math.abs(random.nextInt()/10000000));
