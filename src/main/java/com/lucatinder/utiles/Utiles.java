...
public class Utiles {
	...
	
	{
		...
		Perfil perfil = new Perfil(Math.abs(random.nextInt()), "Seduccion69", "Glymmdok Lopez Gonzalez", random.nextBoolean() ,  Math.abs(random.nextInt()/10000000) , "Me gusta la pizza con pi�a y la paella con chorizo. Busco una "
				+"persona sincera, divertida y cari�osa. <3");
