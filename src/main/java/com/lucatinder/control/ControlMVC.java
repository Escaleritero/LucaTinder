...
public class ControlMVC {
	...
	/**
	 * @param model 
	 * Metodo para crear un objeto para generar un perfil nuevo.
	 * @return registro
	 */
	@GetMapping("/registro")
	...
	/**
	 * @param alias 
	 * Metodo para abrir sesion, validando el alias,  para devolver listado de 20 contactos en principal.
